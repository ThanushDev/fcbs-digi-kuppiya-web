      ...
      <div className="absolute bottom-6 right-6 z-50 flex flex-col items-center gap-3">
        {showContactMenu && (
          <div className="flex flex-col gap-2 animate-fade-in-up">
            ...
            {/* Email Button */}
            <a href="fcbsdigikuppiya@gmail.com" target="_blank" className="flex h-11 w-11 items-center justify-center rounded-full bg-cyan-600 text-white shadow-lg transition hover:scale-110 hover:bg-cyan-700 duration-200">
