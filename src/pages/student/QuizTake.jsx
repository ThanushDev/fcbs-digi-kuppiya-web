...
export default function QuizTake() {
  ...
  if (loading) return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="rounded-2xl border border-gray-800 bg-[#141726] p-6 mb-6">
    ...
    <div className="max-w-3xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <h1 className="mt-1 text-xl font-bold text-white">{quiz.title}</h1>
        </div>
        <div className={`rounded-xl px-4 py-2 text-center ${timeLeft < 60 ? 'bg-red-600/20 text-red-400' : 'bg-gray-800 text-white'}`}>
      ...
      <div className="rounded-2xl border border-gray-800 bg-[#141726] p-6 mb-6">
        ...
        <h2 className="text-lg font-semibold text-white mb-4">{q.text}</h2>
        <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <button onClick={() => setCurrent(Math.max(0, current - 1))} disabled={current === 0}
          className="rounded-lg bg-gray-800 px-6 py-2.5 text-sm font-semibold text-gray-300 hover:bg-gray-700 disabled:opacity-50 transition">
          Previous
        </button>
        {current < questions.length - 1 ? (
          ...
          <button onClick={handleSubmit} disabled={submitting}
            className="rounded-lg bg-emerald-600 px-8 py-2.5 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-50 transition">
